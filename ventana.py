...
class Ventana(Frame):
    ...
    def fGuardar(self):
        if self.bandera == "Guardar":
           ...
           imc2024=0
           try:
              self.dao.inserta_estudiante(cod,nom,edad,al,pe,se,imc2023,imc2024)  
          ...
          #  messagebox.showinfo("Modificar","Modifico")
            ...
            imc2023=(float(pe)/(float(al)*(float(al))))
            imc2024=0
            self.dao.modificar_estudiantes(nom,edad,al,pe,se,imc2023,imc2024,cod)  
    ...
    def crear_widgets(self):
       ...
       lbl1=Label(frame2,text="Dni: ",bg="#5DADE2")
       lbl1.place(x=30, y=20)
       self.txtCodigo=Entry(frame2)
       self.txtCodigo.place(x=30,y=38,width=150,height=20)
       
        #Segunda etiqueta de Nombre
       lbl2=Label(frame2,text="Nombre y Apellido: ",bg="#5DADE2")
       lbl2.place(x=30, y=70)
       self.txtNombre=Entry(frame2)
       self.txtNombre.place(x=30,y=90,width=150,height=20)
       
        
           #Tercera etiqueta de edad
       lblEdad=Label(frame2,text="Edad: ",bg="#5DADE2")
       lblEdad.place(x=30, y=120)
       self.txtEdad=Entry(frame2)
       self.txtEdad.place(x=30,y=140,width=150,height=20)
       
       
        #Cuarta etiqueta de altura
       lbl3=Label(frame2,text="Altura: ",bg="#5DADE2")
       lbl3.place(x=30, y=170)
       self.txtAltura=Entry(frame2)
       self.txtAltura.place(x=30,y=190,width=150,height=20)
       
           #Quinta etiqueta de peso
       lbl4=Label(frame2,text="Peso: ",bg="#5DADE2")
       lbl4.place(x=30, y=220)
       self.txtPeso=Entry(frame2)
       self.txtPeso.place(x=30,y=240,width=150,height=20)
       
           #Sexta  etiqueta de sexo
       lbl5=Label(frame2,text="Sexo: ",bg="#5DADE2")
       lbl5.place(x=30, y=270)
       self.txtSexo=Entry(frame2)
       self.txtSexo.place(x=30,y=290,width=150,height=20)
       ...
       frame3.place(x=380,y=0,width=1500,height=1050)
       
       self.grid=ttk.Treeview(self,columns=("col1","col2","col3","col4","col5","col6","col7","col8"))
       
       self.grid.column("#0",width=80,anchor=CENTER)#CAMPO CERO VA A SER EL ID
       self.grid.column("col1",width=120,anchor=CENTER)#anchor le estamos diciendo que la vamos a centrar dentro del grid
       self.grid.column("col8",width=30,anchor=CENTER)
       self.grid.column("col2",width=30,anchor=CENTER)
       self.grid.column("col3",width=30,anchor=CENTER)
       self.grid.column("col4",width=30,anchor=CENTER)
       self.grid.column("col5",width=30,anchor=CENTER)
       self.grid.column("col6",width=145,anchor=CENTER)
       self.grid.column("col7",width=90,anchor=CENTER)
      
       
       self.grid.heading("#0",text="Dni",anchor=CENTER)#el encabezado para las columnas
       self.grid.heading("col1",text="Nombre y Apellido",anchor=CENTER)
       self.grid.heading("col2",text="Edad",anchor=CENTER)
       self.grid.heading("col3",text="Altura",anchor=CENTER)
       self.grid.heading("col4",text="Peso",anchor=CENTER)
       self.grid.heading("col5",text="Sexo",anchor=CENTER)
       self.grid.heading("col6",text="Indice de Masa Corporal 2023",anchor=CENTER)
       self.grid.heading("col7",text="Indice de Masa Corporal 2024",anchor=CENTER)
       
       #Ponerlo
       self.grid.place(x=400,y=0,width=760,height=400)
